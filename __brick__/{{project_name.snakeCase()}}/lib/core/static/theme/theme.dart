...
extension BuildContextExtension on BuildContext {
  ...
  /// Returns CupertionThemeData for Cupertino Library
  CupertinoThemeData get themeCup => CupertinoTheme.of(this);

  /// Returns Brightness.light/dark based on light/dark mode
  Brightness get bright => _theme.brightness;

  /// Returns true if Dark mode is enabled
  bool get isDark => bright == Brightness.dark;

  /// Returnes true if Light mode is enabled
